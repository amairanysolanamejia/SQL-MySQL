...
CREATE TABLE IF NOT EXISTS transactions (
  ...
  `type` ENUM('sell','lend', 'return') DEFAULT NULL COMMENT ' Borrowed, Returned, Sold',
  created_at TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
INSERT INTO `clients`(client_id, name, email, birthdate, gender, active) VALUES
  (1,'Maria Dolores Gomez','Maria Dolores.95983222J@random.names','1971-06-06','F',0) 
  ON DUPLICATE KEY UPDATE active = VALUES(active);

  /* con duplicate key update actualizamos esta segunda inserción con active = 0*/

  -- Comprobamos que se hayan guardado 
-- select * from clients where client_id = 1\G

-- Ingresar un libro
/* Tenemos estos libros en un CV: "Laberitod de la soledad, Octavio Paz, 1950
Vuelta al laberito de la soledad, Octavio Paz, 1975"*/
INSERT INTO books (title, author_id) VALUES ('El laberito de la soledad', 186);
-- en este segundo caso queremos introducir un nuevo libro con el mismo autor
...
1960);
-- Isertar más libros
/* books( book_id , author_id INTEGER UNSIGNED,  title, year, language,  cover_url,  price , sellabe ,  copies , description
*/
...
(13,7,'Fundamentals of Wavelets',1900,'en',NULL,556,1,4,NULL),
(14,8,'Data Smart',1900,'en',NULL,89,1,4,NULL),
(15,9,'God Created the Integers',1900,'en',NULL,55,1,4,NULL),
(16,10,'Superfreakonomics',1900,'en',NULL,15,1,4,NULL),
(17,11,'Orientalism',1900,'en',NULL,15,1,4,NULL),
(18,12,'The Nature of Statistical Learning Theory',1900,'en',NULL,15,1,4,NULL),
(19,13,'Integration of the Indian States',1900,'en',NULL,15,1,4,NULL),
(20,14,'The Drunkard\'s Walk',1900,'en',NULL,15,1,4,NULL),
(21,15,'Image Processing & Mathematical Morphology',1900,'en',NULL,15,1,4,NULL),
(22,16,'How to Think Like Sherlock Holmes',1900,'en',NULL,15,1,4,NULL),
(23,17,'Data Scientists at Work',1900,'en',NULL,15,1,4,NULL),
(24,18,'Slaughterhouse Five',1900,'en',NULL,15,1,4,NULL),
(25,19,'Birth of a Theorem',1900,'en',NULL,15,1,4,NULL),
(26,20,'Structure & Interpretation of Computer Programs',1900,'en',NULL,15,1,4,NULL),
(27,21,'The Age of Wrath',1900,'en',NULL,15,1,4,NULL),
(28,22,'The Trial',1900,'en',NULL,15,1,4,NULL),
(29,23,'Statistical Decision Theory',1900,'en',NULL,15,1,4,NULL),
(30,24,'Data Mining Handbook',1900,'en',NULL,15,1,4,NULL),
(31,25,'The New Machiavelli',1900,'en',NULL,15,1,4,NULL),
(32,26,'Physics & Philosophy',1900,'en',NULL,15,1,4,NULL),
(33,27,'Making Software',1900,'en',NULL,15,1,4,NULL),
(34,28,'Vol I Analysis',1900,'en',NULL,15,1,4,NULL),
(35,29,'Machine Learning for Hackers',1900,'en',NULL,15,1,4,NULL),
(36,30,'The Signal and the Noise',1900,'en',NULL,15,1,4,NULL),
(37,31,'Python for Data Analysis',1900,'en',NULL,15,1,4,NULL),
(38,32,'Introduction to Algorithms',1900,'en',NULL,15,1,4,NULL),
(39,33,'The Beautiful and the Damned',1900,'en',NULL,15,1,4,NULL),
(40,34,'The Outsider',1900,'en',NULL,15,1,4,NULL),
(41,3,'The - Vol I Complete Sherlock Holmes',1900,'en',NULL,15,1,4,NULL),
(42,3,'The - Vol II Complete Sherlock Holmes',1900,'en',NULL,15,1,4,NULL),
(43,37,'The Wealth of Nations',1900,'en',NULL,15,1,4,NULL),
(44,38,'The Pillars of the Earth',1900,'en',NULL,15,1,4,NULL),
(45,39,'The Tao of Physics',1900,'en',NULL,15,1,4,NULL),
(46,40,'Surely You\'s re Joking Mr Feynman',1900,'en',NULL,15,1,4,NULL),
(47,41,'A Farewell to Arms',1900,'en',NULL,15,1,4,NULL),
(48,42,'The Veteran',1900,'en',NULL,15,1,4,NULL),
(49,43,'False Impressions',1900,'en',NULL,15,1,4,NULL),
(50,44,'The Last Lecture',1900,'en',NULL,15,1,4,NULL),
(51,45,'Return of the Primitive',1900,'en',NULL,15,1,4,NULL),
(52,46,'Jurassic Park',1900,'en',NULL,15,1,4,NULL),
(53,47,'A Russian Journal',1900,'en',NULL,15,1,4,NULL),
(54,48,'Tales of Mystery and Imagination',1900,'en',NULL,15,1,4,NULL),
(55,10,'Freakonomics',1900,'en',NULL,15,1,4,NULL),
(56,39,'The Hidden Connections',1900,'en',NULL,15,1,4,NULL),
(57,51,'The Story of Philosophy',1900,'en',NULL,15,1,4,NULL),
(58,52,'Asami Asami',1900,'en',NULL,15,1,4,NULL),
(59,47,'Journal of a Novel',1900,'en',NULL,15,1,4,NULL),
(60,47,'Once There Was a War',1900,'en',NULL,15,1,4,NULL),
(61,47,'The Moon is Down',1900,'en',NULL,15,1,4,NULL),
(62,56,'The Brethren',1900,'en',NULL,15,1,4,NULL),
(63,57,'In a Free State',1900,'en',NULL,15,1,4,NULL),
(64,58,'Catch 22',1900,'en',NULL,15,1,4,NULL),
(65,59,'The Complete Mastermind',1900,'en',NULL,15,1,4,NULL),
(66,60,'Dylan on Dylan',1900,'en',NULL,15,1,4,NULL),
(67,61,'Soft Computing & Intelligent Systems',1900,'en',NULL,15,1,4,NULL),
(68,62,'Textbook of Economic Theory',1900,'en',NULL,15,1,4,NULL),
(69,63,'Econometric Analysis',1900,'en',NULL,15,1,4,NULL),
(70,64,'Learning OpenCV',1900,'en',NULL,15,1,4,NULL),
(71,65,'Data Structures Using C & C++',1900,'en',NULL,15,1,4,NULL),
(72,66,'A Modern Approach Computer Vision',1900,'en',NULL,15,1,4,NULL),
(73,67,'Principles of Communication Systems',1900,'en',NULL,15,1,4,NULL),
(74,68,'Let Us C',1900,'en',NULL,15,1,4,NULL),
(75,69,'The Amulet of Samarkand',1900,'en',NULL,15,1,4,NULL),
(76,70,'Crime and Punishment',1900,'en',NULL,15,1,4,NULL),
(77,71,'Angels & Demons',1900,'en',NULL,15,1,4,NULL),
(78,72,'The Argumentative Indian',1900,'en',NULL,15,1,4,NULL),
(79,73,'Sea of Poppies',1900,'en',NULL,15,1,4,NULL),
(80,72,'The Idea of Justice',1900,'en',NULL,15,1,4,NULL),
(81,75,'A Raisin in the Sun',1900,'en',NULL,15,1,4,NULL),
(82,76,'All the President\'s Men',1900,'en',NULL,15,1,4,NULL),
(83,43,'A Prisoner of Birth',1900,'en',NULL,15,1,4,NULL),
(84,78,'Scoop!',1900,'en',NULL,15,1,4,NULL),
(85,79,'Ahe Manohar Tari',1900,'en',NULL,15,1,4,NULL),
(86,80,'The Last Mughal',1900,'en',NULL,15,1,4,NULL),
(87,81,'Vol 39 No. 1 Social Choice & Welfare',1900,'en',NULL,15,1,4,NULL),
(88,52,'Radiowaril Bhashane & Shrutika',1900,'en',NULL,15,1,4,NULL),
(89,52,'Gun Gayin Awadi',1900,'en',NULL,15,1,4,NULL),
(90,52,'Aghal Paghal',1900,'en',NULL,15,1,4,NULL),
(91,85,'Maqta-e-Ghalib',1900,'en',NULL,15,1,4,NULL),
(92,86,'Manasa',1900,'en',NULL,15,1,4,NULL),
(93,87,'India from Midnight to Milennium',1900,'en',NULL,15,1,4,NULL),
(94,87,'The Great Indian Novel',1900,'en',NULL,15,1,4,NULL),
(95,89,'O Jerusalem!',1900,'en',NULL,15,1,4,NULL),
(96,89,'The City of Joy',1900,'en',NULL,15,1,4,NULL),
(97,89,'Freedom at Midnight',1900,'en',NULL,15,1,4,NULL),
(98,47,'The Winter of Our Discontent',1900,'en',NULL,15,1,4,NULL),
(99,93,'On Education',1900,'en',NULL,15,1,4,NULL),
(100,94,'Free Will',1900,'en',NULL,15,1,4,NULL),
(101,87,'Bookless in Baghdad',1900,'en',NULL,15,1,4,NULL),
(102,96,'The Case of the Lame Canary',1900,'en',NULL,15,1,4,NULL),
(103,9,'The Theory of Everything',1900,'en',NULL,15,1,4,NULL),
(104,98,'New Markets & Other Essays',1900,'en',NULL,15,1,4,NULL),
(105,99,'Electric Universe',1900,'en',NULL,15,1,4,NULL),
(106,100,'The Hunchback of Notre Dame',1900,'en',NULL,15,1,4,NULL),
(107,47,'Burning Bright',1900,'en',NULL,15,1,4,NULL),
(108,98,'The Age of Discontuinity',1900,'en',NULL,15,1,4,NULL),
(109,103,'Doctor in the Nude',1900,'en',NULL,15,1,4,NULL),
(110,104,'Down and Out in Paris & London',1900,'en',NULL,15,1,4,NULL),
(111,72,'Identity & Violence',1900,'en',NULL,15,1,4,NULL),
(112,80,'Beyond the Three Seas',1900,'en',NULL,15,1,4,NULL),
(113,107,'Talking Straight',1900,'en',NULL,15,1,4,NULL),
(114,108,'Vol 3 Maugham\'s Collected Short Stories',1900,'en',NULL,15,1,4,NULL),
(115,42,'The Phantom of Manhattan',1900,'en',NULL,15,1,4,NULL),
(116,108,'Ashenden of The British Agent',1900,'en',NULL,15,1,4,NULL),
(117,111,'Zen & The Art of Motorcycle Maintenance',1900,'en',NULL,15,1,4,NULL),
(118,112,'The Great War for Civilization',1900,'en',NULL,15,1,4,NULL),
(119,45,'We the Living',1900,'en',NULL,15,1,4,NULL),
(120,114,'The Artist and the Mathematician',1900,'en',NULL,15,1,4,NULL),
(121,93,'History of Western Philosophy',1900,'en',NULL,15,1,4,NULL),
(122,72,'Rationality & Freedom',1900,'en',NULL,15,1,4,NULL),
(123,117,'Clash of Civilizations and Remaking of the World Order',1900,'en',NULL,15,1,4,NULL),
(124,39,'Uncommon Wisdom',1900,'en',NULL,15,1,4,NULL),
(125,119,'One',1900,'en',NULL,15,1,4,NULL),
(126,120,'To Sir With Love',1900,'en',NULL,15,1,4,NULL),
(127,121,'Half A Life',1900,'en',NULL,15,1,4,NULL),
(128,122,'The Discovery of India',1900,'en',NULL,15,1,4,NULL),
(129,52,'Apulki',1900,'en',NULL,15,1,4,NULL),
(130,93,'Unpopular Essays',1900,'en',NULL,15,1,4,NULL),
(131,42,'The Deceiver',1900,'en',NULL,15,1,4,NULL),
(132,76,'Veil: Secret Wars of the CIA',1900,'en',NULL,15,1,4,NULL),
(133,52,'Char Shabda',1900,'en',NULL,15,1,4,NULL),
(134,128,'Rosy is My Relative',1900,'en',NULL,15,1,4,NULL),
(135,108,'The Moon and Sixpence',1900,'en',NULL,15,1,4,NULL),
(136,130,'A Short History of the World',1900,'en',NULL,15,1,4,NULL),
(137,108,'The Trembling of a Leaf',1900,'en',NULL,15,1,4,NULL),
(138,103,'Doctor on the Brain',1900,'en',NULL,15,1,4,NULL),
(139,133,'Simpsons & Their Mathematical Secrets',1900,'en',NULL,15,1,4,NULL),
(140,134,'Pattern Classification',1900,'en',NULL,15,1,4,NULL),
(141,135,'From Beirut to Jerusalem',1900,'en',NULL,15,1,4,NULL),
(142,133,'The Code Book',1900,'en',NULL,15,1,4,NULL),
(143,112,'The Age of the Warrior',1900,'en',NULL,15,1,4,NULL),
(144,138,'The Numbers Behind Numb3rs',1900,'en',NULL,15,1,4,NULL),
(145,47,'A Life in Letters',1900,'en',NULL,15,1,4,NULL),
(146,140,'The Information',1900,'en',NULL,15,1,4,NULL),
(147,141,'Elements of Information Theory',1900,'en',NULL,15,1,4,NULL),
(148,142,'Power Electronics - Rashid',1900,'en',NULL,15,1,4,NULL),
(149,143,'Power Electronics - Mohan',1900,'en',NULL,15,1,4,NULL),
(150,144,'Neural Networks',1900,'en',NULL,15,1,4,NULL),
(151,47,'The Grapes of Wrath',1900,'en',NULL,15,1,4,NULL),
(152,52,'Vyakti ani Valli',1900,'en',NULL,15,1,4,NULL),
(153,12,'Statistical Learning Theory',1900,'en',NULL,15,1,4,NULL),
(154,148,'Empire of the Mughal - The Tainted Throne',1900,'en',NULL,15,1,4,NULL),
(155,148,'Empire of the Mughal - Brothers at War',1900,'en',NULL,15,1,4,NULL),
(156,148,'Empire of the Mughal - Ruler of the World',1900,'en',NULL,15,1,4,NULL),
(157,148,'Empire of the Mughal - The Serpent\'s Tooth',1900,'en',NULL,15,1,4,NULL),
(158,148,'Empire of the Mughal - Raiders from the North',1900,'en',NULL,15,1,4,NULL),
(159,153,'Mossad',1900,'en',NULL,15,1,4,NULL),
(160,154,'Jim Corbett Omnibus',1900,'en',NULL,15,1,4,NULL),
(161,155,'20000 Leagues Under the Sea',1900,'en',NULL,15,1,4,NULL),
(162,156,'Batatyachi Chal',1900,'en',NULL,15,1,4,NULL),
(163,156,'Hafasavnuk',1900,'en',NULL,15,1,4,NULL),
(164,156,'Urlasurla',1900,'en',NULL,15,1,4,NULL),
(165,68,'Pointers in C',1900,'en',NULL,15,1,4,NULL),
(166,160,'The Cathedral and the Bazaar',1900,'en',NULL,15,1,4,NULL),
(167,161,'Design with OpAmps',1900,'en',NULL,15,1,4,NULL),
(168,162,'Think Complexity',1900,'en',NULL,15,1,4,NULL),
(169,163,'The Devil\'s Advocate',1900,'en',NULL,15,1,4,NULL),
(170,45,'Ayn Rand Answers',1900,'en',NULL,15,1,4,NULL),
(171,45,'Philosophy: Who Needs It',1900,'en',NULL,15,1,4,NULL),
(172,166,'Data Analysis with Open Source Tools',1900,'en',NULL,15,1,4,NULL),
(173,167,'Broca\'s Brain',1900,'en',NULL,15,1,4,NULL),
(174,168,'Men of Mathematics',1900,'en',NULL,15,1,4,NULL),
(175,169,'Oxford book of Modern Science Writing',1900,'en',NULL,15,1,4,NULL),
(176,170,'Judiciary and Democracy Justice',1900,'en',NULL,15,1,4,NULL),
(177,171,'The Arthashastra',1900,'en',NULL,15,1,4,NULL),
(178,172,'We the People',1900,'en',NULL,15,1,4,NULL),
(179,172,'We the Nation',1900,'en',NULL,15,1,4,NULL),
(180,174,'The Courtroom Genius',1900,'en',NULL,15,1,4,NULL),
(181,175,'Dongri to Dubai',1900,'en',NULL,15,1,4,NULL),
(182,176,'Foundation History of England',1900,'en',NULL,15,1,4,NULL),
(183,80,'City of Djinns',1900,'en',NULL,15,1,4,NULL),
(184,178,'India\'s Legal System',1900,'en',NULL,15,1,4,NULL),
(185,179,'More Tears to Cry',1900,'en',NULL,15,1,4,NULL),
(186,180,'The Ropemaker',1900,'en',NULL,15,1,4,NULL),
(188,182,'The Prince',1900,'en',NULL,15,1,4,NULL),
(189,183,'Eyeless in Gaza',1900,'en',NULL,15,1,4,NULL),
(190,184,'Tales of Beedle the Bard',1900,'en',NULL,15,1,4,NULL),
(191,185,'Girl with the Dragon Tattoo',1900,'en',NULL,15,1,4,NULL),
(192,185,'Girl who kicked the Hornet\'s Nest',1900,'en',NULL,15,1,4,NULL),
(193,185,'Girl who played with Fire',1900,'en',NULL,15,1,4,NULL),
(194,28,'Structure and Randomness',1900,'en',NULL,15,1,4,NULL),
(195,189,'Image Processing with MATLAB',1900,'en',NULL,15,1,4,NULL),
(196,104,'Animal Farm',1900,'en',NULL,15,1,4,NULL),
(197,70,'The Idiot',1900,'en',NULL,15,1,4,NULL),
(198,192,'A Christmas Carol',1900,'en',NULL,15,1,4,NULL);

-- Cargar tablas desde terminal, esquema, sin datos
--sudo mysql  < script_esquema.sql
-- Cargar  datos desde terminal
--sudo mysql  -D nombredeasededatos < script_datos.sql
